...
namespace LibraryApplicationSystem.Migrations
{
    ...
    [Migration("20230526033502_studentcontactnumber-datatype")]
    partial class studentcontactnumberdatatype
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LibraryApplicationSystem.Entities.Author", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LibraryApplicationSystem.Entities.BookCategories", b =>
                {
                    ...
                    b.ToTable("BookCategoriess");
                });

            modelBuilder.Entity("LibraryApplicationSystem.Entities.Borrower", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LibraryApplicationSystem.Entities.Department", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("LibraryApplicationSystem.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("LibraryApplicationSystem.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("LibraryApplicationSystem.Entities.Borrower", b =>
                {
                    b.HasOne("LibraryApplicationSystem.Entities.Book", "Book")
                        .WithMany()
                        .HasForeignKey("BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LibraryApplicationSystem.Entities.Student", "Student")
                        .WithMany()
