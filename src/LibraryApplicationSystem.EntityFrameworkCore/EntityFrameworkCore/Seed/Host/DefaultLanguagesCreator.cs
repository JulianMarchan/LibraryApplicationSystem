...
namespace LibraryApplicationSystem.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = LibraryApplicationSystemConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(LibraryApplicationSystemDbContext context)
        {
            _context = context;
        }
