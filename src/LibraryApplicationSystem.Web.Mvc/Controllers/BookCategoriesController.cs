...
{
    public class BookCategoriesController : LibraryApplicationSystemControllerBase
    {

        private IBookCategoryAppService _bookCategoriesAppService;
        private IDepartmentAppService _departmentAppService;

        public BookCategoriesController(IBookCategoryAppService bookCategoriesAppService, IDepartmentAppService departmentAppService) 
        {
