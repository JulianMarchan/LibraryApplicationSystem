...
{
    public abstract class LibraryApplicationSystemWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LibraryApplicationSystemWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LibraryApplicationSystemWebMvcModule).Assembly.FullName);
        }
        ...
        protected void UsingDbContext(Action<LibraryApplicationSystemDbContext> action)
        {
            using (var context = IocManager.Resolve<LibraryApplicationSystemDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected T UsingDbContext<T>(Func<LibraryApplicationSystemDbContext, T> func)
        {
            T result;
        ...
        protected async Task UsingDbContextAsync(Func<LibraryApplicationSystemDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LibraryApplicationSystemDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LibraryApplicationSystemDbContext, Task<T>> func)
        {
            T result;
